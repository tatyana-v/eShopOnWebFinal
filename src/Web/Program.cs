...
{
    var baseUrl = builder.Configuration["OrderItemsReserverUrl"];
    client.BaseAddress = new Uri(baseUrl);
});

builder.Services.AddHttpClient("OrderDelivery", client =>
{
    var baseUrlDelivery = builder.Configuration["OrderDeliveryUrl"];
    client.BaseAddress = new Uri(baseUrlDelivery);
});

var sbConn = builder.Configuration["ServiceBusConnection"];
builder.Services.AddSingleton(_sbClient => new ServiceBusClient(sbConn));
